...
if(setpoint.pose.position.x < x_bound[0])
setpoint.pose.position.x = x_bound[0];
if(setpoint.pose.position.x > x_bound[1])
setpoint.pose.position.x = x_bound[1];

if(setpoint.pose.position.y < y_bound[0])
setpoint.pose.position.y = y_bound[0];
if(setpoint.pose.position.y > y_bound[1])
setpoint.pose.position.y = y_bound[1];

if(setpoint.pose.position.z < z_bound[0])
setpoint.pose.position.z = z_bound[0];
if(setpoint.pose.position.z > z_bound[1])
setpoint.pose.position.z = z_bound[1];
return 0;
}
